...
Extensive research has shown that LGBTQ+ individuals and migrants face elevated risks of depression, anxiety, and related mental health conditions. These disparities are shaped by chronic exposure to stress, discrimination, and systemic barriers to care. For example, LGB adults are significantly more likely to experience depression and suicidal ideation than their heterosexual peers (@M_M._2021). Migrants often face compounded stress from legal precarity, social isolation, and acculturative pressures, which can further increase risk. Structural inequalities — such as housing insecurity, lack of insurance, and regional disparities in care — also play a key role.

Medical comorbidities, often more prevalent in marginalized groups, further complicate the mental health landscape. Conditions such as hypertension (@M_A_2014), cholesterol imbalance (@fiedorowicz2010cholesterol), cardiovascular disease (@L_A._2024), chronic obstructive pulmonary disease (COPD) (@F_T._2024), and inflammatory bowel disease (IBD) (@eidelberg2023ibd) have all been linked to increased risk of depression. These health conditions disproportionately affect LGBTQ+ individuals, adding biomedical complexity to social disadvantage.
...
Google Drive folder:  
[https://drive.google.com/drive/folders/1dKNWv3BAB8BY1Y5YK-MlU2HG12Ur1chd?usp=sharing](https://drive.google.com/drive/folders/1dKNWv3BAB8BY1Y5YK-MlU2HG12Ur1chd?usp=sharing)

Code for preprocessing, modeling, and figure generation is available on GitHub:  
[https://github.com/ali3el/alis-thesis.git](https://github.com/ali3el/alis-thesis.git)
